...
def open_new_user_menu():
    ...
    def add_new_user():
        ...
        if DataManager.checkphoneformat(fphoneno)=="datatype":
            messagebox.showerror("Data Type Error","Phone number can only contain numbers!")
        elif DataManager.checkphoneformat(fphoneno)=="length":
        ...
        if result == "phone":
            ...
            messagebox.showinfo("Success","User has been successfully added with a default membership duration of 30 days.")
